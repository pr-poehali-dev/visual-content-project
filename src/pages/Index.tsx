          ...
          <div className="relative flex-1 flex flex-col min-h-0">
            <div className="relative w-full flex-1 overflow-hidden bg-black min-h-[400px] sm:min-h-[500px]">
              {[
                ...
                'https://cdn.poehali.dev/projects/a4b74196-9d6f-4de8-becb-0795012f6edd/bucket/bd7642d1-c1a3-4133-aaf9-6a21a5b9b1b7.mp4',
                'https://cdn.poehali.dev/projects/a4b74196-9d6f-4de8-becb-0795012f6edd/bucket/7e133abb-f4fe-4a70-9494-8efac9fbac05.mp4',
              ].map((src, i, arr) => (
              ...
              <button onClick={() => setCurrentVideosIndex(v => (v - 1 + 4) % 4)}
              ...
              <button onClick={() => setCurrentVideosIndex(v => (v + 1) % 4)}
